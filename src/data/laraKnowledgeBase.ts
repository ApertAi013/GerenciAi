...
export const LARA_CATEGORIES: LaraCategoryInfo[] = [
  ...
  { id: 'torneios', label: 'Torneios e Campeonatos', icon: 'faTrophy', description: 'Campeonatos, sorteios ao vivo, transmissao e ranking' },
  { id: 'lojinha', label: 'Lojinha', icon: 'faShoppingBag', description: 'Loja de produtos para alunos' },
...
export const LARA_MODULES: LaraModule[] = [
  ...
  // ── 2. ALUNOS ──
  {
    ...
    subTopics: [
      ...
      {
        id: 'alunos_link_cadastro',
        label: 'Link de cadastro de alunos',
        keywords: ['link cadastro', 'link aluno', 'cadastro por link', 'auto cadastro', 'self registration', 'compartilhar cadastro', 'link publico aluno'],
        response: 'Voce pode gerar um link publico para que alunos se cadastrem sozinhos! Compartilhe o link via WhatsApp ou redes sociais. O aluno preenche nome, email, telefone, CPF, data de nascimento e sexo. O cadastro chega como "pendente" e voce aprova definindo o nivel do aluno.',
        steps: ['Acesse "Alunos" no menu lateral', 'Clique no botao de link (icone de corrente) ao lado de "+ Aluno"', 'O sistema gera um link unico para sua arena', 'Copie e compartilhe o link com seus alunos', 'Quando alguem se cadastrar, um banner amarelo aparece no topo da pagina de Alunos', 'Clique em "Aprovar", selecione o nivel do aluno e confirme', 'O aluno sera ativado automaticamente!'],
        link: '/alunos',
        linkLabel: 'Ir para Alunos',
      },
      {
        id: 'alunos_aprovar_pendente',
        label: 'Aprovar cadastros pendentes',
        keywords: ['aprovar aluno', 'pendente', 'cadastro pendente', 'aprovar cadastro', 'rejeitar cadastro', 'banner pendente'],
        response: 'Quando alunos se cadastram pelo link publico, eles aparecem como pendentes no topo da pagina de Alunos em um banner amarelo. Voce pode aprovar (definindo o nivel) ou rejeitar cada cadastro.',
        steps: ['Acesse "Alunos" no menu lateral', 'Veja o banner amarelo no topo com os cadastros pendentes', 'Para aprovar: clique em "Aprovar", selecione o nivel do aluno e confirme', 'Para rejeitar: clique em "Rejeitar" e confirme a remocao', 'Ao aprovar, o aluno muda para status "ativo" e fica disponivel para matriculas'],
        link: '/alunos',
        linkLabel: 'Ir para Alunos',
      },
    ],
  ...
  // ── 25. TORNEIOS / CAMPEONATOS ──
  {
    id: 'torneios',
    name: 'Torneios',
    path: '/torneios',
    icon: 'faTrophy',
    description: 'Gestao completa de campeonatos: sorteio ao vivo, transmissao, chaves, ranking e pagina publica.',
    keywords: {
      primary: ['torneio', 'torneios', 'campeonato', 'campeonatos', 'championship', 'tournament'],
      secondary: ['chave', 'bracket', 'eliminacao', 'fase de grupos', 'partida', 'final', 'semifinal', 'classificacao', 'ranking', 'sorteio', 'duplas', 'ao vivo', 'live', 'transmissao', 'stream', 'apertai', 'podio', 'cabeca de chave'],
    },
    category: 'torneios',
    subTopics: [
      {
        id: 'torneio_como_funciona',
        label: 'Como funciona o sistema de torneios',
        keywords: ['como funciona torneio', 'sistema torneio', 'criar campeonato'],
        response: 'O sistema de torneios permite criar campeonatos completos! Crie torneios com sorteio ao vivo de duplas e confrontos (com animacao na pagina publica), transmissao ao vivo com Apertai, pagina publica com placar em tempo real, podio animado e ranking por categoria (duplas, individual, trios).',
        steps: ['Acesse "Torneios" no menu lateral', 'Clique em "Novo Torneio"', 'Preencha titulo, data, local e categoria (beach tennis, futevolei, etc.)', 'Escolha o formato: Eliminacao Simples, Dupla ou Fase de Grupos', 'Defina o tamanho dos times (1x1, 2x2, 3x3, etc.)', 'Para duplas com sorteio, selecione "Sorteio de duplas"', 'Adicione jogadores, marque cabecas de chave, sorteie e inicie!'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_formatos',
        label: 'Formatos de torneio disponiveis',
        keywords: ['formato torneio', 'eliminacao simples', 'eliminacao dupla', 'fase de grupos', 'tipo torneio'],
        response: 'Existem 3 formatos: 1) Eliminacao Simples - perdeu, esta fora. 2) Eliminacao Dupla - segunda chance na chave de perdedores (losers bracket). 3) Fase de Grupos - times jogam em grupos e os melhores avancam. Todos com chave automatica, placar ao vivo e pagina publica.',
        steps: ['Eliminacao Simples: ideal para torneios rapidos', 'Eliminacao Dupla: repescagem com losers bracket, so sai com 2 derrotas', 'Fase de Grupos: configure grupos, times por grupo e quantos avancam', 'Todos os formatos suportam disputa de 3o lugar'],
        link: '/torneios',
        linkLabel: 'Criar torneio',
      },
      {
        id: 'torneio_sorteio_duplas',
        label: 'Sorteio de duplas ao vivo',
        keywords: ['sorteio duplas', 'sortear duplas', 'duplas ao vivo', 'formacao equipes', 'sorteio ao vivo duplas'],
        response: 'Voce pode sortear duplas ao vivo com animacao na pagina publica! Cadastre os jogadores nos lados esquerdo e direito, marque os cabecas de chave (que nao serao pareados juntos), e escolha "Sorteio Ao Vivo" para revelar cada dupla uma por uma com animacao de fogo e suspense.',
        steps: ['Crie o torneio com "Formacao de Equipes" = Sorteio de duplas', 'Adicione os jogadores nos lados esquerdo e direito', 'Marque cabecas de chave clicando no botao de medalha (nao serao pareados juntos)', 'Clique em "Sortear Duplas"', 'Escolha "Sorteio Ao Vivo" para animacao na pagina publica', 'Clique "Sortear Proxima Dupla" para revelar uma por uma, ou "Sortear Todos" de uma vez', 'A pagina publica mostra animacao de sorteio em tempo real!'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_sorteio_confrontos',
        label: 'Sorteio de confrontos ao vivo',
        keywords: ['sorteio confrontos', 'sortear confrontos', 'gerar chave ao vivo', 'sorteio ao vivo confrontos', 'bracket ao vivo'],
        response: 'Apos definir as duplas/equipes, sorteie os confrontos ao vivo! Escolha "Sorteio Ao Vivo" para revelar cada confronto com animacao de suspense (nomes girando e fogo) na pagina publica. Ao final, aparece a tela "Confrontos Definidos!" com a tabela completa.',
        steps: ['Com as equipes definidas, clique em "Sortear Confrontos"', 'Escolha "Sorteio Instantaneo" (gera tudo de uma vez) ou "Sorteio Ao Vivo"', 'No modo ao vivo, clique "Sortear Proximo Confronto" para revelar um por um', 'Ou clique "Sortear Todos" para revelar todos com animacao sequencial', 'A pagina publica mostra spinning de nomes + reveal com fogo em tempo real', 'Ao final, tela de "Confrontos Definidos!" com estrela e tabela de confrontos'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_cabeca_chave',
        label: 'Cabecas de chave',
        keywords: ['cabeca de chave', 'seed', 'seeds', 'cabecas de chave', 'jogador principal'],
        response: 'Marque jogadores como cabeca de chave para garantir que os melhores nao fiquem na mesma dupla! Cabecas de chave sao sempre pareados com jogadores normais no sorteio de duplas. Clique no botao de medalha ao lado do jogador para marcar.',
        steps: ['Na aba Participantes, veja a lista de jogadores', 'Clique no botao "Cabeca de Chave" (medalha) ao lado do jogador', 'Confirme no modal que aparece', 'O jogador fica destacado com borda dourada', 'No sorteio de duplas, dois cabecas de chave NUNCA ficam na mesma dupla'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_inscricao',
        label: 'Inscricao por link publico',
        keywords: ['inscricao torneio', 'link inscricao', 'inscricao publica', 'link torneio', 'cadastro torneio'],
        response: 'Gere um link de inscricao publica para jogadores se inscreverem! Compartilhe via WhatsApp ou redes sociais. Os inscritos aparecem para voce aprovar antes de gerar a chave.',
        steps: ['Ao criar o torneio, selecione modo de inscricao "Link"', 'Copie o link de inscricao', 'Compartilhe via WhatsApp ou redes sociais', 'Jogadores preenchem nome e dados pelo link', 'Voce aprova ou rejeita as inscricoes', 'Quando tiver todos os times, sorteie!'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_partidas',
        label: 'Gerenciar partidas ao vivo',
        keywords: ['partida ao vivo', 'placar', 'live', 'ao vivo', 'iniciar partida', 'score', 'resultado', 'quadra'],
        response: 'Gerencie partidas em tempo real! Ao iniciar, selecione a quadra/camera (obrigatorio com Apertai). Atualize o placar com + e -, e declare o vencedor. A chave atualiza automaticamente. A pagina publica mostra o placar ao vivo com a quadra correta.',
        steps: ['Clique na partida na chave ou aba Jogos', 'Selecione a quadra (Quadra 1 ou Quadra 2) para a transmissao', 'Clique "Iniciar Partida"', 'Use + e - para atualizar o placar', 'Declare o vencedor ao finalizar', 'O vencedor avanca automaticamente na chave', 'Na pagina publica, o placar aparece ao vivo na camera correta'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_editar_chave',
        label: 'Editar chave manualmente',
        keywords: ['editar chave', 'alterar chave', 'mudar resultado', 'desfazer partida', 'trocar equipe', 'renomear equipe'],
        response: 'Voce pode editar a chave manualmente! Na aba Chave, clique em "Alterar Chave Manualmente" para entrar no modo edicao. Clique em qualquer partida para editar placar, desfazer resultado ou trocar equipes. Clique no nome da equipe para renomear.',
        steps: ['Va na aba "Chave" do torneio', 'Clique em "Alterar Chave Manualmente" (canto superior direito)', 'Confirme o alerta de acao irreversivel', 'Clique em qualquer partida para: editar placar, desfazer resultado, trocar posicoes', 'Clique no nome de uma equipe para renomear', 'Tambem pode editar equipes e integrantes na aba Participantes (botao "Editar")'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_transmissao',
        label: 'Transmissao ao vivo (Apertai)',
        keywords: ['transmissao', 'live', 'stream', 'apertai', 'camera', 'ao vivo', 'livestream'],
        response: 'Com o Apertai, transmita seus jogos ao vivo automaticamente! A camera inteligente filma os jogos e a transmissao aparece na pagina publica do torneio. O custo e zero — o Raspberry Pi envia o stream direto via Cloudflare Tunnel. Suporta ate 2 cameras/quadras simultaneas.',
        steps: ['Tenha o Apertai configurado na sua arena (Raspberry Pi + cameras)', 'Ao criar o torneio, a transmissao Apertai e ativada automaticamente', 'Na aba Detalhes do torneio, veja os controles "Transmissao Apertai"', 'Clique "Iniciar Transmissao" para comecar', 'Ao iniciar partidas, selecione a quadra (Cam 1 ou Cam 2)', 'A pagina publica mostra o video + placar ao vivo de cada quadra', 'Voce ve quantas pessoas estao assistindo no painel admin'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_pagina_publica',
        label: 'Pagina publica do torneio',
        keywords: ['pagina publica', 'link publico', 'pagina ao vivo', 'link torneio', 'compartilhar torneio'],
        response: 'Cada torneio tem uma pagina publica que atualiza em tempo real! Mostra chave completa, placares ao vivo, transmissao de video, sorteios animados e podio ao final. Compartilhe o link com os participantes e espectadores. A pagina da arena mostra todos os torneios e ranking.',
        steps: ['Na aba Detalhes, copie o "Link Publico" do torneio', 'Compartilhe com participantes e espectadores', 'A pagina mostra: chave, placares ao vivo, video (se Apertai), equipes', 'Sorteios ao vivo aparecem com animacao automaticamente', 'Ao finalizar, mostra podio animado (1o, 2o e 3o lugar)', 'Clique no nome da arena na pagina para ver todos os torneios e ranking'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        ...
        keywords: ['ranking torneio', 'classificacao', 'pontuacao', 'ranking duplas', 'ranking individual'],
        response: 'O ranking e gerado automaticamente ao finalizar cada torneio, separado por categoria: Duplas, Individual, Trios, etc. Na pagina publica da arena, os visitantes veem o ranking com podio visual (top 3 com medalhas) e tabela completa. No admin, voce tambem visualiza o ranking por categoria.',
        steps: ['Finalize um torneio para gerar o ranking', 'O ranking e calculado automaticamente (pontos por colocacao e vitorias)', 'Na pagina publica da arena, veja a aba "Ranking"', 'Selecione a categoria: Duplas, Individual, Trios, etc.', 'Top 3 aparecem com podio visual (ouro, prata, bronze)', 'No painel admin, aba "Ranking" com o mesmo filtro por categoria'],
        link: '/torneios',
        linkLabel: 'Ver ranking',
      },
      {
        id: 'torneio_patrocinadores',
        label: 'Patrocinadores do torneio',
        keywords: ['patrocinador', 'patrocinio', 'sponsor', 'logo patrocinador', 'banner'],
        response: 'Adicione patrocinadores ao seu torneio! Faca upload do logo, defina se e patrocinador master (destaque maior) e o banner aparece na pagina publica durante a transmissao e tambem em uma secao fixa no final da pagina.',
        steps: ['Na aba "Patrocinadores" do torneio', 'Clique em "Adicionar Patrocinador"', 'Informe nome, descricao e faca upload do logo', 'Marque como "Master" para destaque especial (banner maior, mais tempo de exibicao)', 'O banner rotativo aparece durante a transmissao ao vivo', 'Uma secao fixa "Patrocinado por" aparece no final da pagina publica'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
    ],
  ...
  // ── 26. LOJINHA ──
  {
    ...
    path: '/lojinha',
    icon: 'faShoppingBag',
    description: 'Loja de produtos: cadastro, estoque, pedidos e pagamentos.',
    keywords: {
      primary: ['loja', 'lojinha', 'shop', 'produtos', 'produto', 'vender'],
      secondary: ['estoque', 'pedido', 'pedidos', 'camiseta', 'uniforme', 'acessorio', 'comprar', 'venda', 'mercadoria'],
    },
    category: 'lojinha',
    subTopics: [
      {
        id: 'loja_como_funciona',
        label: 'Como funciona a lojinha',
        keywords: ['como funciona loja', 'sistema loja', 'vender produtos'],
        response: 'A Lojinha permite vender produtos para seus alunos! Cadastre produtos com foto, preco, tamanhos e cores. Os alunos podem ver e comprar pelo aplicativo, e voce gerencia os pedidos com status de pagamento e entrega. Tambem tem um dashboard com faturamento e produtos mais vendidos.',
        steps: ['Acesse "Lojinha" no menu lateral', 'Cadastre seus produtos (nome, foto, preco, estoque)', 'Os alunos veem os produtos no aplicativo mobile', 'Acompanhe os pedidos na aba "Pedidos"', 'Gerencie o status: Pendente > Pago > Separado > Entregue', 'Veja o faturamento e produtos mais vendidos no dashboard'],
        link: '/lojinha',
        linkLabel: 'Ir para Lojinha',
      },
      {
        id: 'loja_criar_produto',
        label: 'Cadastrar novo produto',
        keywords: ['novo produto', 'criar produto', 'cadastrar produto', 'adicionar produto'],
        response: 'Cadastre um produto com nome, descricao, foto, preco e controle de estoque. Voce pode definir tamanhos (P, M, G, GG) e cores disponiveis. Tambem escolha se o estoque e limitado ou ilimitado.',
        steps: ['Acesse "Lojinha"', 'Clique em "Novo Produto"', 'Preencha nome e descricao', 'Faca upload de uma foto do produto', 'Defina o preco', 'Configure estoque: quantidade fixa ou ilimitado', 'Adicione tamanhos disponiveis (ex: P, M, G, GG)', 'Adicione cores disponiveis (ex: Preto, Branco, Azul)', 'Defina a visibilidade (todos, por modalidade ou alunos especificos)', 'Salve o produto'],
        link: '/lojinha',
        linkLabel: 'Ir para Lojinha',
      },
      {
        ...
        keywords: ['pedidos', 'ver pedidos', 'status pedido', 'entregar', 'separar', 'gerenciar pedidos'],
        response: 'Na aba "Pedidos" voce acompanha todas as compras dos alunos. Cada pedido passa pelos status: Pendente (aguardando pagamento), Pago, Separado (pronto para retirada) e Entregue. Voce pode filtrar por status e enviar mensagens via WhatsApp para avisar o aluno.',
        steps: ['Acesse "Lojinha" > aba "Pedidos"', 'Veja todos os pedidos com nome do aluno, produto, tamanho, cor e valor', 'Filtre por status: Pendentes, Pagos, Separados, Entregues, Cancelados', 'Para pagamento direto: confirme o recebimento', 'Marque como "Separado" quando preparar o pedido', 'Marque como "Entregue" quando o aluno retirar', 'Clique no icone do WhatsApp para avisar o aluno sobre o pedido'],
        link: '/lojinha',
        linkLabel: 'Ver pedidos',
      },
      {
        id: 'loja_pagamento',
        label: 'Formas de pagamento da loja',
        keywords: ['pagamento loja', 'pix loja', 'pagar produto', 'taxa loja'],
        response: 'Existem dois tipos de pagamento: Plataforma (PIX) onde o aluno paga pelo app e o valor e depositado na sua conta (com taxas de gateway e plataforma), ou Direto onde voce registra pagamentos em dinheiro/presenciais manualmente.',
        steps: ['Ao criar o produto, escolha o tipo de pagamento', 'Plataforma (PIX): aluno paga pelo app, taxas de 0.99% (gateway) + 2.00% (plataforma)', 'Direto: voce registra o pagamento manualmente quando o aluno pagar presencialmente', 'No pedido, voce confirma o recebimento do pagamento direto'],
        link: '/lojinha',
        linkLabel: 'Ir para Lojinha',
      },
      {
        id: 'loja_dashboard',
        label: 'Dashboard e metricas da loja',
        keywords: ['dashboard loja', 'faturamento loja', 'vendas', 'mais vendidos', 'metricas loja'],
        response: 'O dashboard da Lojinha mostra: faturamento do mes, quantidade de vendas, pedidos pendentes, pedidos separados para retirada, grafico de tendencia de vendas e os produtos mais vendidos.',
        link: '/lojinha',
        linkLabel: 'Ver dashboard',
      },
    ],
