...
export const LARA_CATEGORIES: LaraCategoryInfo[] = [
  ...
  { id: 'torneios_loja', label: 'Torneios e Lojinha', icon: 'faTrophy', description: 'Campeonatos, torneios e loja de produtos' },
...
export const LARA_MODULES: LaraModule[] = [
  ...
  // ── 25. TORNEIOS / CAMPEONATOS ──
  {
    ...
    path: '/torneios',
    icon: 'faTrophy',
    description: 'Gestao completa de campeonatos e torneios: chaves, grupos, partidas ao vivo e inscricoes.',
    keywords: {
      primary: ['torneio', 'torneios', 'campeonato', 'campeonatos', 'championship', 'tournament'],
      secondary: ['chave', 'bracket', 'eliminacao', 'fase de grupos', 'partida', 'final', 'semifinal', 'classificacao', 'ranking'],
    },
    category: 'torneios_loja',
    subTopics: [
      {
        ...
        response: 'O sistema de torneios permite criar campeonatos completos com chave automatica! Voce define o formato (eliminacao simples, eliminacao dupla ou fase de grupos), adiciona os times/duplas, gera a chave e gerencia as partidas ao vivo com placar em tempo real.',
        steps: ['Acesse "Torneios" no menu lateral', 'Clique em "Novo Torneio"', 'Preencha titulo, descricao, datas e local', 'Escolha o formato: Eliminacao Simples, Dupla ou Fase de Grupos', 'Defina o tamanho dos times (1x1, 2x2, 3x3, etc.)', 'Adicione os times manualmente ou gere um link de inscricao', 'Gere a chave e inicie o torneio!'],
        link: '/torneios',
      ...
      },
      {
        ...
        response: 'Existem 3 formatos disponiveis: 1) Eliminacao Simples - perdeu, esta fora. 2) Eliminacao Dupla - tem uma segunda chance na chave de perdedores (losers bracket). 3) Fase de Grupos - times jogam em grupos e os melhores avancam para a fase eliminatoria.',
        steps: ['Eliminacao Simples: ideal para torneios rapidos, cada derrota elimina', 'Eliminacao Dupla: os perdedores vao para a chave de repescagem, so sai com 2 derrotas', 'Fase de Grupos: configure numero de grupos, times por grupo e quantos avancam', 'Na fase de grupos, voce define pontos por vitoria, empate e derrota'],
        link: '/torneios',
      ...
      },
      {
        ...
        response: 'Voce pode gerar um link de inscricao publica para que os jogadores se inscrevam sozinhos! Basta configurar o modo de inscricao como "Link" e compartilhar. Os inscritos aparecem para voce aprovar antes de gerar a chave.',
        steps: ['Ao criar o torneio, selecione o modo de inscricao "Link"', 'Apos salvar, copie o link de inscricao', 'Compartilhe via WhatsApp ou redes sociais', 'Os jogadores preenchem nome e dados da equipe pelo link', 'Voce ve as inscricoes e pode aprovar ou rejeitar', 'Quando tiver todos os times, gere a chave!'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_chave',
        label: 'Gerar e visualizar chave',
        keywords: ['gerar chave', 'bracket', 'chave torneio', 'sorteio', 'montar chave'],
        response: 'Apos adicionar todos os times, clique em "Gerar Chave" para montar o bracket automaticamente. O sistema faz o sorteio e distribui os times. Voce pode visualizar a chave completa com todas as rodadas ate a final.',
        steps: ['Adicione todos os times ao torneio', 'Clique em "Gerar Chave"', 'O sistema sorteia e monta a chave automaticamente', 'Visualize a chave com todas as partidas e rodadas', 'Para eliminacao dupla, veja a chave de vencedores e de perdedores', 'Para fase de grupos, veja as tabelas de classificacao de cada grupo'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        ...
        keywords: ['partida ao vivo', 'placar', 'live', 'ao vivo', 'iniciar partida', 'score', 'resultado'],
        response: 'Gerencie as partidas em tempo real! Inicie a partida, atualize o placar com os botoes de + e -, e declare o vencedor. A chave e atualizada automaticamente e o proximo confronto e montado.',
        steps: ['Na chave do torneio, clique na partida desejada', 'Clique em "Iniciar Partida" para comecar', 'Use os botoes + e - para atualizar o placar de cada time', 'A partida fica marcada como "AO VIVO"', 'Ao finalizar, declare o vencedor', 'O vencedor avanca automaticamente na chave'],
        link: '/torneios',
        linkLabel: 'Ir para Torneios',
      },
      {
        id: 'torneio_ranking',
        label: 'Ranking e classificacao',
        keywords: ['ranking torneio', 'classificacao', 'pontuacao', 'tabela', 'posicao'],
        response: 'O sistema gera um ranking automatico baseado nos resultados das partidas. Na fase de grupos, voce acompanha a tabela de classificacao com pontos, vitorias, derrotas e saldo. No formato eliminatorio, o ranking e baseado na fase que cada time alcancou.',
        link: '/torneios',
